...
// Example usage
async function handleUserJoinProfileList() {
            ...
            .then(data => {
                if (data.loggedIn) {
                    ...
                    if (userData) {
                        ...
                        const sessionData = `➡️ **@${userData.username}** viewed **OpenProfile 5 Author List** from **${name}** ${emoji}`;
                    ...
                    console.log('Specific Element Data:', specificElementData);
                    const sessionData = `➡️ **Guest** viewed **OpenProfile 5 Author List** from **${name}** ${emoji}`;
                    // Send message to server with session data
                    sendSessionDataToServer(sessionData);
                }
            })
