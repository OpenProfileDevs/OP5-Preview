    ...
    function generate_schemes() {
        ...
        schemes.forEach((scheme) => {
            ...
            if (currentMonth !== October && scheme.id === "scheme_spooky" || currentMonth !== February && scheme.id  === "scheme_lunar_red"  || currentMonth !== February && scheme.id  === "scheme_lunar_green" ) {
                ...
                <img src="/media/icons/feather_icons/${scheme.icon}.svg" style="position: relative; top: -48px; width: 40px; transform-origin: top left; margin: 12px; filter: ${icon_brightness};">
...
function scheme_apply(scheme_id, scheme_icon, scheme_text, scheme_accent, scheme_shade_1, scheme_shade_2, scheme_shade_1, scheme_shade_1, scheme_shade_2, scheme_custom_html) {
    ...
    const author_card = document.querySelectorAll('.author-card')
    const side_button_active = document.querySelectorAll('.side_button_active')
    ...
    side_button_active.forEach((side_button_active) => {
        side_button_active.style.backgroundColor = scheme_accent;
    });
